...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002248439945').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/019f5c1e7823b94f12659-515e4795e68527495a.jpg')).split()
